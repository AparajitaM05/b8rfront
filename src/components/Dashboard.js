...
function Dashboard(){
    ...
    return(
       ...
       <Link to="/AddTenant"><button className="CommonnButton" style={{  fontWeight: "1000" , textAlign: "left", fontStyle: "normal", height:"82px",width: "100%" }}>Add <br/> New <br/>Tenant<img className="vectorSignIn" src={vector} alt="fireSpot"/></button></Link>
        </div>
