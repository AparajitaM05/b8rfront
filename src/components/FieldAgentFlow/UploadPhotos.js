  ...
  return (
   ...
   {/* <Dropzone
    ...
    /> */}
      ...
      <div className={`${UploadPhotoscss['button-container form']} ${UploadPhotoscss.form}`} style={{ borderRadius: "16px",height:"1000px"}} >
      <div className="button-container form" style={{height:"1000px", background:"#FFFFFF", marginLeft:"350px", borderRadius:"16px"}}>
