...
import backgroundSecond from "../Assets/Images/PropertyAdditionPageIcons/convenience_store/other_bg.png";
...
function AddTenant(){
    ...
    let axiosConfig = {
	  ...
	  const handleSubmit = event => {
		...
		console.log()
		axios.post('http://127.0.0.1:5000/backend/addtenant',  formData, axiosConfig )
		  .then(response => {
